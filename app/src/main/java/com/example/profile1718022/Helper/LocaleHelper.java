package com.example.profile1718022.Helper;
...
public class LocaleHelper {
    ...
    public static Context onAttach(Context context, String defaultLengauage){
        String lang = getPersistedData(context, defaultLengauage);
        return setLocale(context,lang);
    }
